...
fun <S : KaSession> PsiElement.checkValidity() {
    val session = component.analysisSession as KaBaseSession
    if (!session.canBeAnalysedImpl(this) && Registry.`is`("kotlin.analysis.validate.psi.input", true) && !allowIllegalPsiAccess.get()) {
